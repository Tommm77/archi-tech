...
class __TwigTemplate_666c9f4d18d3b4cb4d06850aaa84dd06 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 4
        echo "<h1>User Account Deletion Notification</h1>
...
<p>The user ";
        ...
        echo " has deleted their account from our platform. Here are some details:</p>
<ul>
    <li>Username: ";
        // line 8
...
<p>If any further actions are required, please carry them out.</p>
<p>Best regards,</p>
...
{% block content %}
<h1>User Account Deletion Notification</h1>
<p>Hello Administrator,</p>
<p>The user {{ email }} has deleted their account from our platform. Here are some details:</p>
<ul>
    <li>Username: {{ email }}</li>
    <li>Number of files deleted: {{ fileCount }}</li>
</ul>
<p>If any further actions are required, please carry them out.</p>
<p>Best regards,</p>
<p>The [ArchiTech] Team</p>
