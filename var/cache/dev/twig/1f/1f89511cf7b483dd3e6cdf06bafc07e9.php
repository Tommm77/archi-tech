...
class __TwigTemplate_d7bdc5177b87ac7643ab7755691ac693 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "user", [], "any", false, false, false, 15), "usestorage", [], "any", false, false, false, 15) >= (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "user", [], "any", false, false, false, 15), "storage", [], "any", false, false, false, 15) * 0.9))) {
    ...
    ";
        // line 23
        if ((isset($context["isAdmin"]) || array_key_exists("isAdmin", $context) ? $context["isAdmin"] : (function () { throw new RuntimeError('Variable "isAdmin" does not exist.', 23, $this->source); })())) {
            // line 24
            echo "    <div class=\"alert alert-info\">
    ...
    <div class=\"mb-3\">
        ...
        <a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("generate_invoice", ["userId" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 31, $this->source); })()), "user", [], "any", false, false, false, 31), "id", [], "any", false, false, false, 31)]), "html", null, true);
    ...
    ";
        // line 36
        if ((twig_length_filter($this->env, (isset($context["files"]) || array_key_exists("files", $context) ? $context["files"] : (function () { throw new RuntimeError('Variable "files" does not exist.', 36, $this->source); })())) > 0)) {
            // line 37
            echo "
    <div class=\"mb-3\">
    ...
    <table class=\"table table-striped mt-3\">
        ...
        <tbody>
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["files"]) || array_key_exists("files", $context) ? $context["files"] : (function () { throw new RuntimeError('Variable "files" does not exist.', 58, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["file"]) {
                // line 59
                echo "            <tr>
                <td>";
                // line 60
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["file"], "getId", [], "method", false, false, false, 60), "html", null, true);
                echo "</td>
                <td>";
                // line 61
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["file"], "getFilename", [], "method", false, false, false, 61), "html", null, true);
                echo "</td>
                <td>";
                // line 62
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["file"], "getFilepath", [], "method", false, false, false, 62), "html", null, true);
                echo "</td>
                <td>";
                // line 63
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["file"], "getFilesize", [], "method", false, false, false, 63), "html", null, true);
                echo " bytes</td>
                <td>";
                // line 64
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["file"], "getFiletype", [], "method", false, false, false, 64), "html", null, true);
                echo "</td>
                <td>";
                // line 65
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["file"], "getDescription", [], "method", false, false, false, 65), "html", null, true);
                echo "</td>
                <td>";
                // line 66
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["file"], "getUploadDate", [], "method", false, false, false, 66), "d-m-Y H:i"), "html", null, true);
                echo "</td>
                <td>";
                // line 67
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["file"], "getCreateDate", [], "method", false, false, false, 67), "d-m-Y H:i"), "html", null, true);
                echo "</td>
                <td>
                    <a href=\"";
                // line 69
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("serve_file", ["filename" => twig_get_attribute($this->env, $this->source, $context["file"], "getFilename", [], "method", false, false, false, 69)]), "html", null, true);
                echo "\" target=\"_blank\" class=\"btn btn-info btn-sm\">View</a>
                </td>
                <td>
                    <a href=\"";
                // line 72
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("file_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["file"], "getId", [], "method", false, false, false, 72)]), "html", null, true);
...
";
    ...
    {
        return array (  285 => 90,  275 => 89,  263 => 85,  253 => 84,  242 => 81,  238 => 79,  233 => 76,  223 => 72,  217 => 69,  212 => 67,  208 => 66,  204 => 65,  200 => 64,  196 => 63,  192 => 62,  188 => 61,  184 => 60,  181 => 59,  177 => 58,  154 => 37,  152 => 36,  146 => 33,  142 => 32,  138 => 31,  134 => 30,  130 => 28,  124 => 24,  122 => 23,  117 => 20,  111 => 16,  109 => 15,  104 => 12,  102 => 11,  96 => 10,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
